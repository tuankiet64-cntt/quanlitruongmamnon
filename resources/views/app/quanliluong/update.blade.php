<div class="modal-header">
    <h4 class="modal-title text-center" id="title_create">Cập nhật lương</h4>
</div>
    ...
    <div class="card card-block mb-0 form-row">
        <div class="container">
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="ngay-update">
            </div>
            <div class="form-group">
                <label class="sub-title">Lương</label>
                <input id="luong-update" class="form-control" type="text">
            </div>
            <div class="form-group">
                <label class="sub-title">Số tiền hằng ngày</label>
                <input type="text" class="form-control" id="luonghangngay-update">
            </div>
        </div>
    </div>
</div>
...
@push('script')
    <script src="../js/component/app/quanliluong/update.js"></script>
@endpush
